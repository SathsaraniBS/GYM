    ...
    <div className="bg-black min-h-screen text-white">
      ...
      {!chatOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 bg-red-600 hover:bg-red-700 text-white rounded-full shadow-lg shadow-red-900/50 flex items-center justify-center text-2xl z-40 transition-all duration-300 hover:scale-110"
          title="AI Coach"
        >
          🤖
        </button>
